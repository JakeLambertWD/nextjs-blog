...
async function handler(req, res) {
  if (req.method == 'POST') {
    ...
    const connectionString = `mongodb+srv://${"next-blog"}:${"euGcIa6KjnfxUAus"}@${"cluster0"}.fwhyj.mongodb.net/${"my-site"}?retryWrites=true&w=majority`;

    try {
      client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect('mongodb+srv://next-blog:euGcIa6KjnfxUAus@cluster0.fwhyj.mongodb.net/my-site?retryWrites=true&w=majority');
    } catch (err) {
      res.status(500).json({
